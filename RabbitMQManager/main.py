...
if __name__ == '__main__':
    ...
    # manager = Manager('sys1','localhost', 8081, 'localhost', 5681, 'localhost', 5680, 'localhost', 8080, 'localhost', 5670)
    # manager = Manager('sys2','localhost', 8082, 'localhost', 5682, 'localhost', 5680, 'localhost', 8080, 'localhost', 5670)